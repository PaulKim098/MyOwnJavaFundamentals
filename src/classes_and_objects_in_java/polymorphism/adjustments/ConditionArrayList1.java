...
public class ConditionArrayList1 extends ArrayList<Integer> {
    private Predicate<Integer> condition;

    public ConditionArrayList1(Predicate<Integer> predicate,
                               Integer... nums) {
        super(new ConditionArrayList1(predicate, Arrays.asList(nums)));
    }
